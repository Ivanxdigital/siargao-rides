  ...
  "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        brand: "bg-primary/20 text-primary border border-primary/30 backdrop-blur-sm shadow-[0_0_15px_rgba(38,176,154,0.3)] font-medium",
        comingSoon: "bg-primary/20 text-primary border border-primary/30 backdrop-blur-sm font-medium",
      },
    },
    defaultVariants: {
      variant: "default",
